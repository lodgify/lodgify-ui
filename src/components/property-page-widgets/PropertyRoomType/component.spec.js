...
const getPropertyRoomType = () => shallow(<PropertyRoomType {...props} />);
const getWrappedPropertyRoomType = () => {
...
describe('<PropertyRoomType />', () => {
  ...
  describe('`Card`', () => {
    const firstCardInComponent = () => getWrappedPropertyRoomType().find(Card);
